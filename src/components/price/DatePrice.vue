...
<template>
    ...
    <div class="grid-container">
        ...
        <div class="card flex justify-content-center">
            <MultiSelect v-model="selectedOptions" variant="filled" :options="additionally" optionLabel="name"
                placeholder="Дополнительно" :maxSelectedLabels="1" class="w-full md:w-20rem" />
        </div>
    </div>
