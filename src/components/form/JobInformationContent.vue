...
const department = ref([
    { name: 'Административный отдел', code: '0-0', supervisor: 'Сухов Даниил Иванович' },
    { name: 'Финансовый отдел', code: '0-1', supervisor: 'Сухов Даниил Иванович' },
    { name: 'Маркетинговый отдел', code: '0-2', supervisor: 'Сухов Даниил Иванович' },
    { name: 'Коммерческий отдел', code: '0-3', supervisor: 'Сухов Даниил Иванович' },

    { name: 'Отдел кадров', code: '0-0-0', supervisor: 'Горбова Елена (ИО)' },
    { name: 'Юридический отдел', code: '0-0-1', supervisor: 'Горбова Елена (ИО)' },
    { name: 'Отдел АХО', code: '0-0-2', supervisor: 'Горбова Елена (ИО)' },


    { name: 'Бухгалтерия', code: '0-1-0', supervisor: 'Сухов Даниил Иванович (ИО)' },

    { name: 'IT отдел', code: '0-2-0', supervisor: 'Сухов Даниил Иванович (ИО)' },
    { name: 'Отдел маркетинго', code: '0-2-1', supervisor: 'Сухов Даниил Иванович (ИО)' },

    { name: 'Отдел развития', code: '0-3-0', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Отдел продаж KRAFTER', code: '0-3-1', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Отдел продаж листовой HPL', code: '0-3-2', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Отдел продаж KRAFTER Мебель', code: '0-3-3', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Отдел продаж Атэри', code: '0-3-4', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Отдел продаж фурнитура', code: '0-3-5', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Тендерный отдел', code: '0-3-6', supervisor: 'Зацепина Регина (ИО)' },
    { name: 'Сметно-договорной отдел', code: '0-3-7', supervisor: 'Зацепина Регина (ИО)' },
])
