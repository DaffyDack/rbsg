...
const items = ref([
    ...
    { page: 'projects', id: 5, nameProject: 'Настроить комп' },
    { page: 'projects', id: 6, nameProject: 'Настроить комп' },
    { page: 'projects', id: 7, nameProject: 'Настроить комп' },
    { page: 'projects', id: 8, nameProject: 'Настроить комп' },
])
